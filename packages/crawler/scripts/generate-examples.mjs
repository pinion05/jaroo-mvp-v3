...
const exampleRequests = [
  ...
  { id: 'wisereport-kr-slim-v11-005930', path: '/api/source/wisereport-fnguide/kr/companies/005930/slim/v1.1' },
  ...
  { id: 'market-indicators-vkospi', path: '/api/source/stockplus/market/indicators/vkospi' },
  { id: 'market-indicators-adr', path: '/api/source/adrinfo/market/indicators/adr' },
  { id: 'market-indicators-us-vix', path: '/api/source/investing/us/market/indicators/vix' },
  { id: 'wisereport-global-slim-v11-nvda', path: '/api/source/wisereport-global/us/companies/NVDA/slim/v1.1' },

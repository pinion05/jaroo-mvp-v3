...
const exampleRequests = [
  ...
  { id: 'wisereport-kr-slim-v11-005930', path: '/api/major/wisereport-fnguide/kr/companies/005930/slim/v1.1' },
  { id: 'market-overview-kr', path: '/api/source/naver-finance/kr/market/overview' },
  { id: 'market-fx-usd-krw', path: '/api/major/market/fx/usd-krw' },
  ...
  { id: 'wisereport-global-slim-v11-nvda', path: '/api/major/wisereport-global/us/companies/NVDA/slim/v1.1' },

...
const exampleRequests = [
  { id: 'health', path: '/api/source/system/health' },
  { id: 'catalog', path: '/api/source/system/catalog' },
  { id: 'wisereport-kr-005930', path: '/api/source/wisereport-fnguide/kr/companies/005930' },
  { id: 'market-overview-kr', path: '/api/source/naver-finance/kr/market/overview' },
  { id: 'market-fx-usd-krw', path: '/api/source/investing/market/fx/usd-krw' },
  { id: 'market-indicators', path: '/api/source/stockplus-adrinfo-investing/market/indicators' },
  { id: 'market-indicators-vkospi', path: '/api/source/stockplus-adrinfo-investing/market/indicators/vkospi' },
  { id: 'market-indicators-adr', path: '/api/source/stockplus-adrinfo-investing/market/indicators/adr' },
  { id: 'market-indicators-us-vix', path: '/api/source/stockplus-adrinfo-investing/market/indicators/us-vix' },
  { id: 'wisereport-global-nvda', path: '/api/source/wisereport-global/us/companies/NVDA' },
  { id: 'wisereport-global-nvda-domain', path: '/api/source/wisereport-global/us/companies/NVDA/domain' },
  { id: 'us-stock-financials-nvda', path: '/api/source/fmp-polygon-finnhub-wisereport-global/us/stocks/NVDA/financials' },
  { id: 'us-stock-consensus-nvda', path: '/api/source/fmp-finnhub-wisereport-global/us/stocks/NVDA/consensus' },
  { id: 'us-stock-news-nvda', path: '/api/source/polygon-finnhub-wisereport-global/us/stocks/NVDA/news' },
  { id: 'us-stock-filings-nvda', path: '/api/source/finnhub-sec-edgar/us/stocks/NVDA/filings' },
  { id: 'us-stock-company-facts-nvda', path: '/api/source/sec-edgar/us/stocks/NVDA/company-facts' },
  { id: 'us-stock-company-facts-nvda-taxonomies', path: '/api/source/sec-edgar/us/stocks/NVDA/company-facts/taxonomies' },
  { id: 'us-stock-company-facts-nvda-us-gaap-concepts', path: '/api/source/sec-edgar/us/stocks/NVDA/company-facts/taxonomies/us-gaap/concepts' },
  { id: 'us-stock-company-facts-nvda-us-gaap-assets', path: '/api/source/sec-edgar/us/stocks/NVDA/company-facts/taxonomies/us-gaap/concepts/Assets' },
  { id: 'us-market-indicators', path: '/api/source/polygon-yahoo/us/market/indicators' },
  { id: 'us-stock-report-nvda', path: '/api/source/fmp-polygon-finnhub-sec-edgar-yahoo-wisereport-global/us/stocks/NVDA/report' },
  { id: 'krx-ohlcv-005930', path: '/api/source/krx-js-client/kr/stocks/005930/ohlcv?startDate=20250301&endDate=20250330' },
  { id: 'krx-index-1001', path: '/api/source/krx-js-client/kr/indexes/1001/ohlcv?startDate=20250301&endDate=20250330' },
  { id: 'krx-investor-volume-005930', path: '/api/source/krx-js-client/kr/stocks/005930/investor-volume?startDate=20250301&endDate=20250330' },
  { id: 'krx-market-snapshot-kospi-20250328', path: '/api/source/krx-js-client/kr/market/snapshot?tradeDate=20250328&market=KOSPI' },
  { id: 'krx-market-cap-kospi-20250328', path: '/api/source/krx-js-client/kr/market/cap?tradeDate=20250328&market=KOSPI' },
  { id: 'krx-tickers-kospi', path: '/api/source/krx-js-client/kr/market/tickers?market=KOSPI' },
  { id: 'krx-trigger-batch-morning', path: '/api/source/krx-js-client/kr/batches/trigger?mode=morning' },
];

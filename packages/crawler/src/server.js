...
const endpointDefinitions = [
  ...
  },
  {
    ...
    description: 'USD/KRW 환율 스냅샷을 반환합니다. Yahoo chart를 1차 원천으로 사용하고 open.er-api.com을 보조 원천으로 사용합니다.',
    primaryPath: buildMajorPath('/market/fx/usd-krw'),
    dataSources: ['yahoo-finance', 'open-er-api'],
    params: [],
    query: [],
    count: 1,
  ...
  },
  {
    ...
    description: 'VKOSPI, ADR, US VIX를 한 번에 반환합니다. OCI에서 차단된 VKOSPI는 blocked 상태로 표시하고 US VIX는 Yahoo chart를 사용합니다.',
    primaryPath: buildDataSourcePath('stockplus-adrinfo-investing', '/market/indicators'),
    dataSources: ['stockplus', 'adrinfo', 'yahoo-finance'],
    params: [],
    query: [],
  ...
  },
  {
    ...
    description: 'US VIX 단일 지표를 Yahoo chart 원천으로 반환합니다.',

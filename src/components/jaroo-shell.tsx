...
export function JarooShell({
  ...
  return (
    <div className='min-h-dvh bg-white text-foreground sm:bg-[color:var(--jaroo-canvas)] sm:px-6 sm:py-4'>
      <div className='relative mx-auto flex min-h-dvh w-full flex-col overflow-hidden bg-white sm:min-h-[calc(100vh-2rem)] sm:max-w-[390px] sm:rounded-[32px] sm:border sm:border-white/70 sm:shadow-[0_20px_60px_rgba(12,68,124,0.18)]'>

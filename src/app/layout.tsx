    ...
    >
      <body className='min-h-full bg-background font-sans text-foreground' suppressHydrationWarning>
        ...
        {/* h-dvh(확정 높이): 내부 스크롤 컨테이너(main/tabbar)가 높이 제한을 받아
          ...
          <div className='relative mx-auto flex h-dvh w-full max-w-[390px] flex-col overflow-hidden bg-white sm:h-[calc(100dvh-2rem)] sm:rounded-[32px] sm:shadow-[0_20px_60px_rgba(12,68,124,0.18)]'>
            {children}
          </div>
        </div>
      </body>
